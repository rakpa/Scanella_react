...
class _CreateAccountScreenState extends ConsumerState<CreateAccountScreen> {
  ...
  /// Reaching the app through login or sign-up counts as finishing the
  /// intro. Without this the router would bounce a first-run user who just
  /// logged in straight back to /welcome.
  void _enterApp() {
                  ...
                  child: Form(
                    ...
                    child: Column(
                      children: [
                        ...
                        const Text(
                          // "anywhere" promised sync. Scans never leave the
                          // phone, so an account cannot reach them elsewhere.
